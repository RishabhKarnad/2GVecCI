...
import set_parameters_test as set_parameters
...
#summary = fcs.summary(configurations, random_state=rng, test= 'full',ambiguity=0.01, CI_test_method='GPDC',  max_sep_set=None, linear=True, noise_type='gaussian', standardize=True)
...
summary_dict = fcs.summary_vanilla_PC_linear(configurations, random_state=rng)
